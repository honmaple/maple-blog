            ...
            <div id="carousel-example-captions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="static/images/storm-bg.jpg" style="height:300px;width:100%">
                    ...
                    <div class="item" v-for="carousel in carousels">
                        <img :src="carousel.url" alt="..." style="height:300px;width:100%">
                        <div class="carousel-caption">
...
<script>
 export default {
     data () {
         return {
             pictures:[
                 {"title":"11","description":"222","url":"./static/images/storm-bg.jpg"},
                 {"title":"11",
                  "description":"Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.",
                  "url":"./static/images/storm-bg.jpg"},
                 {"title":"11","description":"222","url":"./static/images/storm-bg.jpg"},
                 {"title":"11","description":"222","url":"./static/images/storm-bg.jpg"},
             ],
             carousels:[
