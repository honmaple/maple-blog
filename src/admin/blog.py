...
# Last Update:星期日 2017-2-12 16:41:10 (CST)
#          By:
# Description:
# **************************************************************************
from .views import BaseModelView
from api.blog.models import Blog, Comment, Tags, Category
from maple.extensions import db, cache
# from maple.helper import CacheKey
...
class BlogView(BaseModelView):
    ...
    #     cache_key = CacheKey.blog(model.id)
